...
У нас есть стабильная версия библиотеки с работающими функциями. Сейчас мы хотим добавить в неё несколько связанных по смыслу функций, предварительно убедившись в их работоспособности.

Для того чтобы работать над изменениями в проекте и не сломать ничего в стабильной версии существуют ветки.
...
---
 ...
 - Измените функцию проверки года на вискокосность так, чтобы она работала корректно в современной системе летоисчисления (годы, кратные четырём вискокостные, если они не кратны 100, однако такие годы високостны, если они кратны 400). Перепишите тесты, чтобы они корректно проверяли новое содержание метода. Сделайте коммит.
