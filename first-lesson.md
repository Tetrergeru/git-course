...
Не стоит злоупотреблять реверсированием коммитов, потому что каждое реверсирование будет создавать свой коммит, что затруднит последующую работу с историей коммитов.
